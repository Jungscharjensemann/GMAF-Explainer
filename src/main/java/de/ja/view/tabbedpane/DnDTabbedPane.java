...
/**
 * JTabbedPane mit verschiebbaren Tabs.
 * Entnommen aus: https://java-swing-tips.blogspot.com/2008/04/drag-and-drop-tabs-in-jtabbedpane.html
 */
public class DnDTabbedPane extends JTabbedPane {
    ...
    private void initGlassPane(Component c, Point tabPt) {
        ...
        if(hasGhost()) {
            Component component = getTabComponentAt(dragTabIndex);
            Component copy = Optional.ofNullable(component)
